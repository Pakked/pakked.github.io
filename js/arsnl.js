$(document).ready(function () {
    ...
    function submitSignup() {
        ...
        $.ajax({
            type: "POST",
            url: "https://www.atypicalthemes.com/portfolio/arsnl_demo/pages/general1v/php/newsletter-process.php",
    ...
    function psubmitForm() {
        ...
        $.ajax({
            type: "POST",
            url: "https://www.atypicalthemes.com/portfolio/arsnl_demo/pages/general1v/php/privacyform-process.php",
